      ...
      <section>
        ...
        <div className="px-4 md:px-8 lg:px-12 py-8 md:py-12">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="w-full md:w-1/2 h-auto">
              <Image
                ...
                width={800}
                alt="The Dandy Chair"
                className="w-full h-auto object-cover" // Removed hover effect here
              />
            </div>
              ...
              <div className="text-[#505977] text-sm md:text-base">
                ...
                <div className="flex flex-wrap justify-between items-center mt-8">
                  <div className="flex items-center gap-4">
                    <h1>Amount:</h1>
                    <button className="flex gap-4 bg-white rounded-md px-4 py-2">
          ...
          <div className="my-10 flex justify-center">
            <button className="bg-white py-3 px-6 rounded-md text-[#2A254B]">
              View collection
            </button>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-6 mt-12 text-sm md:text-base">
            {features.map((feature, idx) => {
              const Icon = feature.icon; // Dynamically render the icon
              return (
